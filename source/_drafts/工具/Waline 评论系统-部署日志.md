...
cover: 'https://img.ccknbc.cc/blog/2021-01-17~15-08-37.webp'
photos: 'https://img.ccknbc.cc/blog/2021-01-17~15-08-37.webp'
comments: true
id: 20
...
![](https://img.ccknbc.cc/blog/2021-04-02~10-58-01.png!/format/webp/lossless/true)
...
{% endnote %}
![](https://img.ccknbc.cc/blog/2021-04-02~10-58-08.png!/format/webp/lossless/true)
对于新用户或者说没有创建过按量计费环境的用户会显示如下内容，记得勾选开启免费资源
![](https://img.ccknbc.cc/blog/2021-04-02~10-58-14.png!/format/webp/lossless/true)
![](https://img.ccknbc.cc/blog/2021-04-02~10-58-27.png!/format/webp/lossless/true)
...
没错，这个环境不错吧
![](https://img.ccknbc.cc/blog/2021-04-02~10-58-34.png!/format/webp/lossless/true)
按照提示购买后稍等几分钟，[在这个界面可查看您所购买的环境](https://console.cloud.tencent.com/tcb/env/index)
![](https://img.ccknbc.cc/blog/2021-04-02~10-58-40.png!/format/webp/lossless/true)
...
![](https://img.ccknbc.cc/blog/2021-04-02~10-58-57.png!/format/webp/lossless/true)
下图中的函数代码部分填入以下代码
![](https://img.ccknbc.cc/blog/2021-04-02~10-59-41.png!/format/webp/lossless/true)
...
![](https://img.ccknbc.cc/blog/2021-04-02~10-59-49.png!/format/webp/lossless/true)
注意点击**保存并安装依赖**，可能会没有反应一会儿，然后等待转圈圈部署完毕即可
![](https://img.ccknbc.cc/blog/2021-04-02~10-59-55.png!/format/webp/lossless/true)
...
![](https://img.ccknbc.cc/blog/2021-04-02~11-00-08.png!/format/webp/lossless/true)
...
![](https://img.ccknbc.cc/blog/2021-04-02~11-00-12.png!/format/webp/lossless/true)
...
找到 Vercel 帮你在创建的仓库，叫 `waline`  啦，编辑 `package.json`  中依赖版本号即可完成升级，版本号以 `npm` ![](https://img.shields.io/npm/v/@waline/vercel?color=critical&logo=npm&style=flat-square)
...
![](https://img.ccknbc.cc/blog/2021-04-02~11-00-26.png!/format/webp/lossless/true!format/webp)
