...
<script class='js-pjax' src='https://cdn.jsdmirror.com/npm/butterfly-friend/butterfly-friend.umd.js'></script>
<link rel="stylesheet" href='https://cdn.jsdmirror.com/npm/butterfly-friend/style.css'>
<script>
...
xkFriend.init({
  ...
  loading_img: 'https://cdn.jsdmirror.com/gh/ccknbc-backup/photos/blog/2021-03-08~15-13-15.gif', // 加载中的图片
  fail_img: 'https://cdn.jsdmirror.com/gh/ccknbc-backup/photos/blog/2021-03-08~15-13-15.gif' // 加载失败的图片
})
</script>
</div>
...
<!-- {% link 顺便看看友链截图列表，您可复制使用啦, https://cdn.jsdmirror.com/gh/ccknbc-actions/blogroll@webp/, https://cdn.jsdmirror.com/www.jsdelivr.com/c903573129ce0afdbc8b006baf86dba514615495/img/logo-horizontal.svg %} -->
...
avatar: https://cdn.jsdmirror.com/gh/ccknbc-backup/cdn/logo/CC.png
descr: CC康纳百川的小窝
```
选填信息
```yaml
...
screenshot: https://cdn.jsdmirror.com/gh/ccknbc-actions/blogroll@webp/blog.ccknbc.cc.webp
