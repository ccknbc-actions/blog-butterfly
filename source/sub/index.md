...
---
<!-- <script data-pjax defer src="https://code.tidio.co/rmnlrpff1oci9pui1djmeuvx1mftupfq.js" async></script> -->
...
<!-- 1. 邮件订阅，点击右下角与CC聊天，任意发送一条消息后，出现介绍自己界面时勾选订阅点击发送即可完成订阅  -->
1. 邮件订阅，前往 [**订阅界面一**](https://briefcake.com/s/ccknbc) 或 [**订阅界面二**](https://ccknbc.mailchimpsites.com) （推荐）
2. RSS订阅 [rss](/rss.xml) 或 [atom](/atom.xml) 通过邮件或阅读器阅读
3. 本页面中转邮件订阅（若无法显示可能需要科学上网）
