...
hexo.extend.filter.register('before_generate', () => {
  ...
  const thirdPartySrcCDN = (pre) => {
    return {
      ...
      gitalk: `${pre}gitalk/dist/gitalk.min.js`,
      ...
      katex: `${pre}katex/dist/katex.min.css`,
      katex_copytex: `${pre}katex/dist/contrib/copy-tex.min.js`,
      katex_copytex_css: `${pre}katex/dist/contrib/copy-tex.css`,
