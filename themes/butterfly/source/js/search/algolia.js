      ...
      templates: {
        item: function (data) {
          ...
          return (
            ...
            data._highlightResult.title.value + '</b><br>( 匹配字词 : ' 
            + '<font color="#8fbc8f">' + data._highlightResult.contentStrip.matchedWords + '</font> ) | ( 匹配等级 : ' 
            + '<font color="#8fbc8f">' + data._highlightResult.contentStrip.matchLevel + '</font> )<br>'
            + data._snippetResult.contentStrip.value + '</a>'
            // + '<br>'
