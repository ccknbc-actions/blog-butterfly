...
---
{% note green success modern %}CC的部落格 外挂标签笔记 ，其中大部分完整转载至糖果屋店长原文，根据本站实际情况进行了增减{% link 外挂标签, /posts/introduction-of-plugin-tags-based-on-butterfly/, https://cdn.jsdelivr.net/gh/ccknbc-backup/cdn/logo/logo.png %}{% endnote %}
...
{% sitegroup %}
{% site xaoxuu, url=https://xaoxuu.com, screenshot=https://i.loli.net/2020/08/21/VuSwWZ1xAeUHEBC.jpg, avatar=https://cdn.jsdelivr.net/gh/ccknbc-backup/cdn/logo/logo.png, description=简约风格 %}
...
关于预览，更多详细内容，请分别前往插件文档 https://shen-yu.gitee.io/2020/chartjs/ | 原文档 https://chartjs.bootcss.com/docs/ 查看（因 pjax 原因，我排除了 'chart*' 因此控制台会出现闪现报错情况）

{% note info simple %}未完待续{% endnote %}