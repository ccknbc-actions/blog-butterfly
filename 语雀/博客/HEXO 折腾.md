...
subtitle: Hexo Toss
---
[HEXO折腾](https://blog.ccknbc.cc/posts/hexo-toss/)
...
比如 `git remote add origin git@github.com:CCKNBC/Hexo.git`，添加多个仓库地址等更多操作请参考**Git-基础-远程仓库的使用**，按照个人喜好来添加多个仓库地址，我这里全部使用的origin,通过手动添加了coding,gitee的仓库地址，不影响使用就行
